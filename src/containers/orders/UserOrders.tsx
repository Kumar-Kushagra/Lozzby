          ...
          <ScrollView
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor:
                  orderStatus === 'PENDING' ? theme.primary : 'lavender',
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginLeft: getScreenHeight(1),
                backgroundColor:
                  orderStatus === 'ACCEPTED' ? theme.primary : 'lavender',
                padding: getScreenHeight(1),
                borderRadius: 16,
                paddingHorizontal: getScreenHeight(3),
              }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginLeft: getScreenHeight(1),
                backgroundColor:
                  orderStatus === 'REJECTED' ? theme.primary : 'lavender',
                padding: getScreenHeight(1),
                borderRadius: 16,
                paddingHorizontal: getScreenHeight(3),
              }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginLeft: getScreenHeight(1),
                backgroundColor:
                  orderStatus === 'DELIVERED' ? theme.primary : 'lavender',
                padding: getScreenHeight(1),
                borderRadius: 16,
                paddingHorizontal: getScreenHeight(3),
              }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginLeft: getScreenHeight(1),
                backgroundColor:
                  orderStatus === 'COMPLETED' ? theme.primary : 'lavender',
                padding: getScreenHeight(1),
                borderRadius: 16,
                paddingHorizontal: getScreenHeight(3),
              }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginLeft: getScreenHeight(1),
                backgroundColor:
                  orderStatus === 'CANCELLED' ? theme.primary : 'lavender',
                padding: getScreenHeight(1),
                borderRadius: 16,
                paddingHorizontal: getScreenHeight(3),
              }}>
